...
/* ------------------------------------------------------------------ */
/*  Mobile Drawer (rendered via Portal to avoid backdrop-filter bug)   */
/* ------------------------------------------------------------------ */
function ArMobileDrawer({
  open,
  onClose,
}: {
  open: boolean;
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-80 max-w-[calc(100vw-3rem)] bg-white shadow-2xl z-[9999] lg:hidden flex flex-col"
          >
            {/* Drawer Header */}
...
export default function ArHeader() {
  ...
  return (
    <>
      ...
      {/* Mobile Drawer — rendered via Portal on document.body */}
      <ArMobileDrawer
        open={mobileMenuOpen}
