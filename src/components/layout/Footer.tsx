...
const QUICK_LINKS = [
  ...
  { label: "Book a Forklift", href: "/contact#booking" },
];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                <p className="font-bold text-lg">Need a Forklift Right Now?</p>
                <p className="text-sm text-white/80">
                  Same-Day Deployment Available. Call us and we&apos;ll have a forklift at your site today.
                </p>
              </div>
            </div>
            <a
              href={`tel:${SITE_CONFIG.phone}`}
              className="btn-pulse shine-effect inline-flex items-center gap-2 bg-white text-primary px-6 py-3 rounded-lg font-bold text-sm hover:bg-gray-100 transition-colors shrink-0 shadow-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
              {SITE_CONFIG.tagline} Jeddah&apos;s most trusted forklift rental
              company. Serving {SITE_CONFIG.clientCount} clients since{" "}
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-5">Rental Services</h3>
            <ul className="space-y-3">
